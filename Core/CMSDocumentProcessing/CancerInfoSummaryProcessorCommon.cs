...
//        protected const string MediaLinkSnippetTemplate = "pdqSnMediaLink";
        protected const string StandardMediaLinkSnippetTemplate = "pdqSnMediaLink";
        protected const string MobileMediaLinkSnippetTemplate = "pdqMSnMediaLink";
        ...
        protected abstract string MediaLinkSnippetTemplate { get; }
        ...
        protected void CreateSubPages(SummaryDocument summary, string createPath,
