  ...
  <div class="contentzone">
    ...
    <div>
     ...
     <div class="on-this-page">
      ...
      <ul>
       <li><a href="#basictrial">Basic Trial Information</a></li>
       <li><a href="#basictrial">Trial Description</a>
        <ul>
         <li><a href="#summary">Summary</a></li>
         <li><a href="#furtherinfo">Further Trial Information</a></li>
         <li><a href="#eligibilitycriteria">Eligibility Criteria</a></li>
        </ul>
       </li>
       <li><a href="#trialcontact">Trial Contact Information</a></li>
      </ul>
     </div>
