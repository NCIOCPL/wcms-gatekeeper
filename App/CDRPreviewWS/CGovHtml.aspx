...
<head id="header">
    ...
    <script src="<%=serverUrl%>/PublishedContent/js/Common.js" type="text/javascript"></script>
    <script src="<%=serverUrl%>/PublishedContent/js/ContentPage.js" type="text/javascript"></script>
    <script src="<%=serverUrl%>/PublishedContent/js/PDQPage.js" type="text/javascript"></script>
