...
namespace GateKeeper.UnitTest.GlossaryTerm
{
    ...
    /// </summary>
    [TestFixture]
    public class GlossaryTermSaveTest
    {
        #region Fields
        ...
        public void TestGlossaryTermByCDRID()
        {
            ...
            {
                //int cdrID = 44927;
               // RequestData requestData = RequestManager.LoadRequestDataByCdrid(110990, cdrID);  // without prettyurl link
                int cdrID = 335128;
                RequestData requestData = RequestManager.LoadRequestDataByCdrid(448, cdrID);  // with prettyurl link
